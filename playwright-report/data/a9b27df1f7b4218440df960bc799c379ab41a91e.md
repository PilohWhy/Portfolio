...
- Name: tier1_features.spec.ts >> F5: Skills Grid Layout >> test 23: Luau & Roblox Ecosystem card with visual icon exists
- Location: tests\e2e\tier1_features.spec.ts:208:7
...
Locator: locator('[data-testid="skill-card-luau"], [data-testid="skill-card"]:has-text("Luau & Roblox Ecosystem")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="skill-card-luau"], [data-testid="skill-card"]:has-text("Luau & Roblox Ecosystem")').first()
