...
- Name: tier1_features.spec.ts >> F4: Reviews Masonry Grid >> test 19: exact text for Studio Lead review
- Location: tests\e2e\tier1_features.spec.ts:176:7
...
Locator: locator('[data-testid="review-card-studiolead"], [data-testid="review-card"]:has-text("Studio Lead (NDA)")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="review-card-studiolead"], [data-testid="review-card"]:has-text("Studio Lead (NDA)")').first()
