...
- Name: tier1_features.spec.ts >> F5: Skills Grid Layout >> test 22: Low-Level & Engines card with visual icon exists
- Location: tests\e2e\tier1_features.spec.ts:201:7
...
Locator: locator('[data-testid="skill-card-low-level"], [data-testid="skill-card"]:has-text("Low-Level & Engines")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="skill-card-low-level"], [data-testid="skill-card"]:has-text("Low-Level & Engines")').first()
