...
- Name: tier1_features.spec.ts >> F5: Skills Grid Layout >> test 21: skills grid exists
- Location: tests\e2e\tier1_features.spec.ts:196:7
...
Locator: locator('[data-testid="skills-grid"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="skills-grid"]')
