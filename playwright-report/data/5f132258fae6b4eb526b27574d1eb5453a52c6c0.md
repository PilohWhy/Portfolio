...
- Name: tier1_features.spec.ts >> F3: Dynamic Routing >> test 13: details page displays metadata
- Location: tests\e2e\tier1_features.spec.ts:114:7
...
Locator: locator('[data-testid="project-role"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="project-role"]')
