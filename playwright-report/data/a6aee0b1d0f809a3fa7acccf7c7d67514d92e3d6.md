...
- Name: tier1_features.spec.ts >> F6: About & Contact Details (JSON) >> test 27: quote block is rendered
- Location: tests\e2e\tier1_features.spec.ts:242:7
...
Locator: locator('[data-testid="quote-block"], blockquote').first().or(locator('body'))
Expected substring: "I'd rather have a few bugs now than dozens later."
...
Call log:
  ...
  - waiting for locator('[data-testid="quote-block"], blockquote').first().or(locator('body'))
    14 × locator resolved to <body class="min-h-full flex flex-col bg-[#111216] text-[#E2E8F0]">…</body>
