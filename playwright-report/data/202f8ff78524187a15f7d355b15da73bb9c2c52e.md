...
- Name: tier1_features.spec.ts >> F6: About & Contact Details (JSON) >> test 29: contact details are formatted like JSON config output
- Location: tests\e2e\tier1_features.spec.ts:259:7
