...
- Name: tier3_pairwise.spec.ts >> Tier 3: Pairwise Combinations >> test 4: JSON contact section visibility and position checks
- Location: tests\e2e\tier3_pairwise.spec.ts:51:7
...
Locator: locator('[data-testid="contact-json"], [data-testid="contact-section"], #contact').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="contact-json"], [data-testid="contact-section"], #contact').first()
