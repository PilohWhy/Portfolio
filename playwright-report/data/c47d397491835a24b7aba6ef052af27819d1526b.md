...
- Name: tier1_features.spec.ts >> F6: About & Contact Details (JSON) >> test 28: contact details contain Discord, Email, Roblox, GitHub, Status
- Location: tests\e2e\tier1_features.spec.ts:249:7
...
Locator: locator('[data-testid="contact-section"], [data-testid="contact-json"]').first().or(locator('body'))
Expected substring: "Discord"
...
Call log:
  ...
  - waiting for locator('[data-testid="contact-section"], [data-testid="contact-json"]').first().or(locator('body'))
