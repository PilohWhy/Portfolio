...
- Name: tier1_features.spec.ts >> F4: Reviews Masonry Grid >> test 18: exact text for @Dev_Alex review
- Location: tests\e2e\tier1_features.spec.ts:169:7
...
Locator: locator('[data-testid="review-card-devalex"], [data-testid="review-card"]:has-text("@Dev_Alex")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="review-card-devalex"], [data-testid="review-card"]:has-text("@Dev_Alex")').first()
