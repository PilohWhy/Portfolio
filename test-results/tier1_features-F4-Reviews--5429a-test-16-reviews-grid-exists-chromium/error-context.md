...
- Name: tier1_features.spec.ts >> F4: Reviews Masonry Grid >> test 16: reviews grid exists
- Location: tests\e2e\tier1_features.spec.ts:157:7
...
Locator: locator('[data-testid="reviews-grid"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="reviews-grid"]')
