...
- Name: tier1_features.spec.ts >> F3: Dynamic Routing >> test 14: details page displays challenges and solutions
- Location: tests\e2e\tier1_features.spec.ts:128:7
...
Locator: locator('[data-testid="project-challenges"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="project-challenges"]')
