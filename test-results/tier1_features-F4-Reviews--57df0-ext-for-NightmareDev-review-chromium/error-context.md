...
- Name: tier1_features.spec.ts >> F4: Reviews Masonry Grid >> test 20: exact text for @NightmareDev review
- Location: tests\e2e\tier1_features.spec.ts:183:7
...
Locator: locator('[data-testid="review-card-nightmaredev"], [data-testid="review-card"]:has-text("@NightmareDev")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="review-card-nightmaredev"], [data-testid="review-card"]:has-text("@NightmareDev")').first()
