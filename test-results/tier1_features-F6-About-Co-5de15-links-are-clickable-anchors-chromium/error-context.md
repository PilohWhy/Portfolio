...
- Name: tier1_features.spec.ts >> F6: About & Contact Details (JSON) >> test 30: contact links are clickable anchors
- Location: tests\e2e\tier1_features.spec.ts:265:7
...
Locator: locator('a[href*="roblox.com"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href*="roblox.com"]')
