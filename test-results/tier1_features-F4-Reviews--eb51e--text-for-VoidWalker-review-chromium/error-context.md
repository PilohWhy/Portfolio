...
- Name: tier1_features.spec.ts >> F4: Reviews Masonry Grid >> test 17: exact text for @VoidWalker review
- Location: tests\e2e\tier1_features.spec.ts:162:7
...
Locator: locator('[data-testid="review-card-voidwalker"], [data-testid="review-card"]:has-text("@VoidWalker")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="review-card-voidwalker"], [data-testid="review-card"]:has-text("@VoidWalker")').first()
